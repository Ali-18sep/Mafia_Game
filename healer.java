...
public class healer extends players {
	...
	private static ArrayList<healer> h = new ArrayList<>();
	protected static int total_healerAlive;

	private int userID=0;

	public healer(int i, int random_int, String string) {
	...
	public static ArrayList<healer> getH() {
		return h;
	}
	...
	public void gamePlay(int id) {
		...
		//while(number_of_alive_mafia!=players.getPlayer_alive()-number_of_alive_mafia || number_of_alive_mafia!=0 || players.getPlayer_alive()!=0) {
		while(true) {	
		...
		//	System.out.println("-----------------CHECKER:--------------"+" "+healer.total_healerAlive);
			...
			if(healer.total_healerAlive!=0) {
				if(mafia_runner.isAlive[userID]==true) {
	...
	public void winnerCall() {
		if(players.getPlayer_alive()==0 || mafia.number_of_alive_mafia==players.getPlayer_alive()-mafia.number_of_alive_mafia) {
			System.out.println();
